    ...
    >
      ...
      <div className="container-main max-w-[900px] text-center relative z-10">
        ...
        >
          ...
          <a href="https://chat.daltonlab.ai/" target="_blank" rel="noopener noreferrer" className="relative group bg-white text-zinc-900 font-semibold text-base md:text-lg px-8 py-4 md:px-10 md:py-5 rounded-full shadow-2xl hover:shadow-xl hover:bg-zinc-100 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 inline-flex items-center justify-center">
