    ...
    <section className="relative min-h-screen flex flex-col overflow-hidden" style={{ backgroundColor: '#101823' }}>
      ...
      <div className="relative z-10 flex-1 flex items-center container mx-auto px-6 md:px-12 lg:px-20 pt-20 md:pt-24">
        <div className="max-w-5xl">
          {/* Badge above H1 */}
          <div 
            className={`inline-flex items-center gap-1.5 backdrop-blur-sm border border-zinc-700/30 rounded-full px-3 py-1.5 mb-6 transition-all duration-700 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}
            style={{ backgroundColor: 'rgba(245, 243, 240, 0.5)' }}
          >
            <span className="text-zinc-900/50 text-xs font-medium">Powered by</span>
            <svg className="w-3.5 h-3.5 text-zinc-900/50" viewBox="0 0 24 24" fill="currentColor">
            ...
            <span className="text-zinc-900/50 font-semibold text-xs">OpenAI</span>
          </div>
          ...
          <h1 
            ...
            style={{ color: '#F5F3F0' }}
          >
            <span className="block text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold">
          ...
          >
            <button 
              className="font-medium text-sm md:text-base px-6 py-3 md:px-8 md:py-4 rounded-lg shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-2"
