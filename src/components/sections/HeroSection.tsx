...
import metaLogo from '@/assets/tech/meta-logo.png';
    ...
    >
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center container mx-auto px-6 md:px-12 lg:px-20 pt-20 md:pt-24">
        <div className="text-center max-w-4xl">
          ...
          >
            <button
              className="font-medium text-sm px-5 py-2.5 rounded-lg shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 inline-flex items-center justify-center gap-2"
              style={{
