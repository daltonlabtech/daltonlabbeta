    ...
    <section className="relative min-h-screen flex flex-col overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex-1 flex items-center container mx-auto px-6 md:px-12 lg:px-20 pt-20 md:pt-24">
        <div className="max-w-5xl">
          ...
          {/* Heading */}
          <h1 
            className={`font-inter font-extrabold tracking-tight text-white leading-[1.1] transition-all duration-700 delay-100 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}
          >
          ...
          {/* Subtitle */}
          <p 
            className={`text-base sm:text-lg md:text-xl text-white/80 font-normal max-w-xl mt-6 md:mt-8 transition-all duration-700 delay-300 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}
          >
